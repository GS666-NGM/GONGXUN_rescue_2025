...
class Primitive(metaclass=Metaclass_Primitive):
    ...
    def __eq__(self, other):
        ...
        if self.char_test != other.char_test:
            return False
        if any(self.char_array_test != other.char_array_test):
            return False
        if self.float32_test != other.float32_test:
            return False
        if any(self.float32_array_test != other.float32_array_test):
            return False
        if self.double_test != other.double_test:
            return False
        if any(self.float64_array_test != other.float64_array_test):
            return False
        if self.int8_test != other.int8_test:
            return False
        if any(self.int8_array_test != other.int8_array_test):
            return False
        if self.uint8_test != other.uint8_test:
            return False
        if any(self.uint8_array_test != other.uint8_array_test):
            return False
        if self.int16_test != other.int16_test:
            return False
        if any(self.int16_array_test != other.int16_array_test):
            return False
        if self.uint16_test != other.uint16_test:
            return False
        if any(self.uint16_array_test != other.uint16_array_test):
            return False
        if self.int32_test != other.int32_test:
            return False
        if any(self.int32_array_test != other.int32_array_test):
            return False
        if self.uint32_test != other.uint32_test:
            return False
        if any(self.uint32_array_test != other.uint32_array_test):
            return False
        if self.int64_test != other.int64_test:
            return False
        if any(self.int64_array_test != other.int64_array_test):
            return False
        if self.uint64_test != other.uint64_test:
            return False
        if any(self.uint64_array_test != other.uint64_array_test):
            return False
